...
static void aSumAsiChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_asi_chest02, &cKF_ba_r_int_sum_asi_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumAsiChest02_func = {
    &aSumAsiChest02_ct, &aSumAsiChest02_mv, &aSumAsiChest02_dw, &aSumAsiChest02_dt, NULL,
};
