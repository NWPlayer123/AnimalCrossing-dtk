...
static void aSumLiccaLowChest_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_liccalowchest, &cKF_ba_r_int_sum_liccalowchest, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumLiccaLowChest_func = {
    &aSumLiccaLowChest_ct, &aSumLiccaLowChest_mv, &aSumLiccaLowChest_dw, &aSumLiccaLowChest_dt, NULL,
};
