...
static void fIJT_dw(FTR_ACTOR* ftr_actor, ACTOR* my_room_actor, GAME* game, u8* data) {
    static u8* tex_table[] = {
        int_ike_jny_truthface1_TA_tex_txt,
...
static aFTR_vtable_c fIJT_func = {
    &fIJT_ct, &fIJT_mv, &fIJT_dw, &fIJT_dt, NULL,
};

aFTR_PROFILE iam_ike_jny_truth01 = {
    NULL, NULL, NULL, NULL, NULL,       NULL, NULL, NULL, 15.7f, 0.01f, aFTR_SHAPE_TYPEB_0, mCoBG_FTR_TYPEB_0,
    0,    0,    0,    0,    &fIJT_func,
};
