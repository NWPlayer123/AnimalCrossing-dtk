...
static void aSumContChest03_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_cont_chest03, &cKF_ba_r_int_sum_cont_chest03, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumContChest03_func = {
    &aSumContChest03_ct, &aSumContChest03_mv, &aSumContChest03_dw, &aSumContChest03_dt, NULL,
};
