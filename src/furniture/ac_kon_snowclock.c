...
static int aKonSnowclock_DwAfter(GAME* game, cKF_SkeletonInfo_R_c* keyf, int jointNum, Gfx** joint, u8* jointFlag,
...
static int aKonSnowclock_DwBefore(GAME* game, cKF_SkeletonInfo_R_c* keyf, int jointNum, Gfx** joint, u8* jointFlag,
                                  void* arg, s_xyz* joint1, xyz_t* trans) {
...
static void aKonSnowclock_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyf, &cKF_bs_r_int_kon_snowclock, &cKF_ba_r_int_kon_snowclock, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aKonSnowclock_func = {
    &aKonSnowclock_ct, &aKonSnowclock_mv, &aKonSnowclock_dw, &aKonSnowclock_dt, NULL,
};
