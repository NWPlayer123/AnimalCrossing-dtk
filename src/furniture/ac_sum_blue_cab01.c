...
static void aSumBlueCab01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_blue_cab01, &cKF_ba_r_int_sum_blue_cab01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumBlueCab01_func = {
    &aSumBlueCab01_ct, &aSumBlueCab01_mv, &aSumBlueCab01_dw, &aSumBlueCab01_dt, NULL,
};
