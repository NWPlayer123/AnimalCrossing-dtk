...
static aFTR_vtable_c aSumHarp_func = {
    &aSumHarp_ct, &aSumHarp_mv, &aSumHarp_dw, &aSumHarp_dt, NULL,
};

aFTR_PROFILE iam_sum_harp = {
    int_sum_harp_on_model, int_sum_harp_onT_model, NULL, NULL, NULL, NULL, NULL,           NULL, 18.0f, 0.01f,
    aFTR_SHAPE_TYPEA,      mCoBG_FTR_TYPEA,        0,    0,    0,    0,    &aSumHarp_func,
};
