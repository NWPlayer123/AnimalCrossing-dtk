...
static void aSumContChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_cont_chest02, &cKF_ba_r_int_sum_cont_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumContChest02_func = {
    &aSumContChest02_ct, &aSumContChest02_mv, &aSumContChest02_dw, &aSumContChest02_dt, NULL,
};
