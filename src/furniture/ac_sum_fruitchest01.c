...
static void aSumFruitchest01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_fruitchest01, &cKF_ba_r_int_sum_fruitchest01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumFruitchest01_func = {
    &aSumFruitchest01_ct, &aSumFruitchest01_mv, &aSumFruitchest01_dw, &aSumFruitchest01_dt, NULL,
};
