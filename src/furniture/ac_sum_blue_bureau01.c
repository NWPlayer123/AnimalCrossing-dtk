...
static void aSumBlueBureau01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_blue_bureau01, &cKF_ba_r_int_sum_blue_bureau01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumBlueBureau01_func = {
    &aSumBlueBureau01_ct, &aSumBlueBureau01_mv, &aSumBlueBureau01_dw, &aSumBlueBureau01_dt, NULL,
};
