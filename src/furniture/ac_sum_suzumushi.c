...
static void aSumSuzumushi_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_suzumushi, &cKF_ba_r_int_sum_suzumushi, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumSuzumushi_func = {
    &aSumSuzumushi_ct, &aSumSuzumushi_mv, &aSumSuzumushi_dw, NULL, NULL,
};
