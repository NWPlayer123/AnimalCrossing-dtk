...
static void aNogTriChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_nog_tri_chest02, &cKF_ba_r_int_nog_tri_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aNogTriChest02_func = {
    &aNogTriChest02_ct, &aNogTriChest02_mv, &aNogTriChest02_dw, &aNogTriChest02_dt, NULL,
};
