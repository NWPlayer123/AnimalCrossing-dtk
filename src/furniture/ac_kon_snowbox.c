...
static void aKonSnowbox_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyf, &cKF_bs_r_int_kon_snowbox, &cKF_ba_r_int_kon_snowbox, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aKonSnowbox_func = {
    &aKonSnowbox_ct, &aKonSnowbox_mv, &aKonSnowbox_dw, &aKonSnowbox_dt, NULL,
};
