...
static void aSumFruitchest03_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_fruitchest03, &cKF_ba_r_int_sum_fruitchest03, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumFruitchest03_func = {
    &aSumFruitchest03_ct, &aSumFruitchest03_mv, &aSumFruitchest03_dw, &aSumFruitchest03_dt, NULL,
};
