...
static void aSumGreChest03_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_gre_chest03, &cKF_ba_r_int_sum_gre_chest03, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumGreChest03_func = {
    &aSumGreChest03_ct, &aSumGreChest03_mv, &aSumGreChest03_dw, &aSumGreChest03_dt, NULL,
};
