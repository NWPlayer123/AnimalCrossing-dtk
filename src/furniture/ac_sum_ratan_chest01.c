...
static void aSumRatanChest01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_ratan_chest01, &cKF_ba_r_int_sum_ratan_chest01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumRatanChest01_func = {
    &aSumRatanChest01_ct, &aSumRatanChest01_mv, &aSumRatanChest01_dw, &aSumRatanChest01_dt, NULL,
};
