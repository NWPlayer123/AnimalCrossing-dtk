...
static void aSumLogChest01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_log_chest01, &cKF_ba_r_int_sum_log_chest01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumLogChest01_func = {
    &aSumLogChest01_ct, &aSumLogChest01_mv, &aSumLogChest01_dw, &aSumLogChest01_dt, NULL,
};
