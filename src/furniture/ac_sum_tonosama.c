...
static void aSumTonosama_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_tonosama, &cKF_ba_r_int_sum_tonosama, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumTonosama_func = {
    &aSumTonosama_ct, &aSumTonosama_mv, &aSumTonosama_dw, NULL, NULL,
};
