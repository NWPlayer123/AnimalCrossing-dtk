...
static void aSumHalChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_hal_chest02, &cKF_ba_r_int_sum_hal_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumHalChest02_func = {
    &aSumHalChest02_ct, &aSumHalChest02_mv, &aSumHalChest02_dw, &aSumHalChest02_dt, NULL,
};
