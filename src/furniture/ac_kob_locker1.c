...
static void aKobLocker1_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyf, &cKF_bs_r_int_kob_locker1, &cKF_ba_r_int_kob_locker1, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aKobLocker1_func = {
    &aKobLocker1_ct, &aKobLocker1_mv, &aKobLocker1_dw, &aKobLocker1_dt, NULL,
};
