...
static void aSumWhiChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_whi_chest02, &cKF_ba_r_int_sum_whi_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumWhiChest02_func = {
    &aSumWhiChest02_ct, &aSumWhiChest02_mv, &aSumWhiChest02_dw, &aSumWhiChest02_dt, NULL,
};
