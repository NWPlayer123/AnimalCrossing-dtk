...
static void aSumClChest03_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_clchest03, &cKF_ba_r_int_sum_clchest03, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumClChest03_func = {
    &aSumClChest03_ct, &aSumClChest03_mv, &aSumClChest03_dw, &aSumClChest03_dt, NULL,
};
