...
static void aSumLiccachest_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_liccachest, &cKF_ba_r_int_sum_liccachest, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumLiccachest_func = {
    &aSumLiccachest_ct, &aSumLiccachest_mv, &aSumLiccachest_dw, &aSumLiccachest_dt, NULL,
};
