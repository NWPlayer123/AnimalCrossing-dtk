...
static void aNogTriChest03_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_nog_tri_chest03, &cKF_ba_r_int_nog_tri_chest03, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aNogTriChest03_func = {
    &aNogTriChest03_ct, &aNogTriChest03_mv, &aNogTriChest03_dw, &aNogTriChest03_dt, NULL,
};
