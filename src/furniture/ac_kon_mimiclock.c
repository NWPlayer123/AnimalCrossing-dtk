...
static int aKonMimiclock_DwAfter(GAME* game, cKF_SkeletonInfo_R_c* keyf, int jointNum, Gfx** joint, u8* jointFlag,
                                 void* arg, s_xyz* joint1, xyz_t* trans) {
    return 1;
}

static int aKonMimiclock_DwBefore(GAME* game, cKF_SkeletonInfo_R_c* keyf, int jointNum, Gfx** joint, u8* jointFlag,
                                  void* arg, s_xyz* joint1, xyz_t* trans) {
...
static void aKonMimiclock_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyf, &cKF_bs_r_int_kon_mimiclock, &cKF_ba_r_int_kon_mimiclock, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aKonMimiclock_func = {
    &aKonMimiclock_ct, &aKonMimiclock_mv, &aKonMimiclock_dw, &aKonMimiclock_dt, NULL,
};
