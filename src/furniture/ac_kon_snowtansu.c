...
static void aKonSnowtansu_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyf, &cKF_bs_r_int_kon_snowtansu, &cKF_ba_r_int_kon_snowtansu, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aKonSnowtansu_func = {
    &aKonSnowtansu_ct, &aKonSnowtansu_mv, &aKonSnowtansu_dw, &aKonSnowtansu_dt, NULL,
};
