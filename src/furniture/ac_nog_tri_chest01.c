...
static void aNogTriChest01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_nog_tri_chest01, &cKF_ba_r_int_nog_tri_chest01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aNogTriChest01_func = {
    &aNogTriChest01_ct, &aNogTriChest01_mv, &aNogTriChest01_dw, &aNogTriChest01_dt, NULL,
};
