...
static void aSumXChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_x_chest02, &cKF_ba_r_int_sum_x_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumXChest02_func = {
    &aSumXChest02_ct, &aSumXChest02_mv, &aSumXChest02_dw, &aSumXChest02_dt, NULL,
};
