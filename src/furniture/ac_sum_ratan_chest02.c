...
static void aSumRatanChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_ratan_chest02, &cKF_ba_r_int_sum_ratan_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumRatanChest02_func = {
    &aSumRatanChest02_ct, &aSumRatanChest02_mv, &aSumRatanChest02_dw, &aSumRatanChest02_dt, NULL,
};
