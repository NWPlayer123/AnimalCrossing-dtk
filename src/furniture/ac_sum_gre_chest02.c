...
static void aSumGreChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_gre_chest02, &cKF_ba_r_int_sum_gre_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumGreChest02_func = {
    &aSumGreChest02_ct, &aSumGreChest02_mv, &aSumGreChest02_dw, &aSumGreChest02_dt, NULL,
};
