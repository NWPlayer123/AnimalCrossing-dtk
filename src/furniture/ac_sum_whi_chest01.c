...
static void aSumWhiChest01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_whi_chest01, &cKF_ba_r_int_sum_whi_chest01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumWhiChest01_func = {
    &aSumWhiChest01_ct, &aSumWhiChest01_mv, &aSumWhiChest01_dw, &aSumWhiChest01_dt, NULL,
};
