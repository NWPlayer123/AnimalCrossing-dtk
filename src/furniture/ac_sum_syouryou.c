...
static void aSumSyouryou_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_syouryou, &cKF_ba_r_int_sum_syouryou, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumSyouryou_func = {
    &aSumSyouryou_ct, &aSumSyouryou_mv, &aSumSyouryou_dw, NULL, NULL,
};
