...
static void aSumClchest01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_clchest01, &cKF_ba_r_int_sum_clchest01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumClchest01_func = {
    &aSumClchest01_ct, &aSumClchest01_mv, &aSumClchest01_dw, &aSumClchest01_dt, NULL,
};
