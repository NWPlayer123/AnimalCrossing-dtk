...
static void aSumBlaChest03_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_bla_chest03, &cKF_ba_r_int_sum_bla_chest03, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumBlaChest03_func = {
    &aSumBlaChest03_ct, &aSumBlaChest03_mv, &aSumBlaChest03_dw, &aSumBlaChest03_dt, NULL,
};
