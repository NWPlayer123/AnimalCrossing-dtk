...
static void aSumBlaChest02_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_log_chest02, &cKF_ba_r_int_sum_log_chest02, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumBlaChest02_func = {
    &aSumBlaChest02_ct, &aSumBlaChest02_mv, &aSumBlaChest02_dw, &aSumBlaChest02_dt, NULL,
};
