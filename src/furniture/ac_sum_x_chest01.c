...
static void aSumXChest01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_x_chest01, &cKF_ba_r_int_sum_x_chest01, ftr_actor->joint,
                          ftr_actor->morph);
...
static aFTR_vtable_c aSumXChest01_func = {
    &aSumXChest01_ct, &aSumXChest01_mv, &aSumXChest01_dw, &aSumXChest01_dt, NULL,
};
