...
static void aSumBlueLowChest01_ct(FTR_ACTOR* ftr_actor, u8* data) {
    ...
    cKF_SkeletonInfo_R_ct(keyframe, &cKF_bs_r_int_sum_blue_lowchest01, &cKF_ba_r_int_sum_blue_lowchest01,
...
static aFTR_vtable_c aSumBlueLowChest01_func = {
    &aSumBlueLowChest01_ct, &aSumBlueLowChest01_mv, &aSumBlueLowChest01_dw, &aSumBlueLowChest01_dt, NULL,
};
