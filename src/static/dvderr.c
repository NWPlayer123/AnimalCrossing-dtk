...
static Vp Dvderr_viewport = { { { 1280, 960, 511, 0 }, { 1280, 960, 511, 0 } } };
...
static Gfx Dvderr_initial_dl[] = {
    ...
    gsDPSetScissor(G_SC_NON_INTERLACE, 0, 0, 640,
                   480),         /* set scissor to screen size, TODO: should probably be defintions */
...
extern int dvderr_draw() {
    static const DVDERR_DRAW_PROC draw_proc[DVDERR_NUM] = { &dvderr_draw_CoverOpen, &dvderr_draw_NoDisk,
                                                            &dvderr_draw_WrongDisk, &dvderr_draw_Retry,
                                                            &dvderr_draw_Fatal };
...
extern void dvderr_init() {
    ...
    guOrtho(&this->ortho, -160.0f, 160.0f, -120.0f, 120.0f, -800.0f, 800.0f,
            1.0f); /* TODO: N64 screen size macros (float) */
