...
static void mTI_timeIn_ovl_move(Submenu* submenu) {
    static mSM_MOVE_PROC ovl_move_proc[mSM_OVL_PROC_NUM] = { &mTI_move_Move, &mTI_move_Play, (mSM_MOVE_PROC)&none_proc1,
                                                             (mSM_MOVE_PROC)&none_proc1, &mTI_move_End };
...
static void mTI_set_frame_dl(Submenu* submenu, GRAPH* graph, f32 x, f32 y) {
    static u8* week_tex[lbRTC_WEEK] = { tim_win_sun_tex_rgb_i4, tim_win_mon_tex_rgb_i4, tim_win_tue_tex_rgb_i4,
                                        tim_win_wed_tex_rgb_i4, tim_win_thu_tex_rgb_i4, tim_win_fri_tex_rgb_i4,
                                        tim_win_sat_tex_rgb_i4 };

    static u8* month_tex[lbRTC_MONTHS_MAX] = { tim_win_january_tex_rgb_i4,   tim_win_february_tex_rgb_i4,
                                               tim_win_march_tex_rgb_i4,     tim_win_april_tex_rgb_i4,
                                               tim_win_may_tex_rgb_i4,       tim_win_june_tex_rgb_i4,
                                               tim_win_july_tex_rgb_i4,      tim_win_august_tex_rgb_i4,
                                               tim_win_september_tex_rgb_i4, tim_win_october_tex_rgb_i4,
                                               tim_win_november_tex_rgb_i4,  tim_win_december_tex_rgb_i4 };
...
static void mTI_set_character(Submenu* submenu, GAME* game, f32 x, f32 y) {
    ...
    mFont_SetLineStrings(game, str_line_adjust, sizeof(str_line_adjust), x + 131.0f, -y + 82.0f, 255, 255, 255, 255,
    ...
    /* Draw 'OK' */
    mFont_SetLineStrings(game, str_line_ok, sizeof(str_line_ok), x + 220.0f, -y + 141.0f, col[0], col[1], col[2], 255,
