...
static void mChoice_MainSetup(mChoice_c* choice, GAME* game) {
    static mChoice_MAIN_PROC proc[mChoice_MAIN_INDEX_NUM] = { &mChoice_MainSetup_Hide, &mChoice_MainSetup_Appear,
                                                              &mChoice_MainSetup_Normal, &mChoice_MainSetup_Disappear };
...
extern void mChoice_Main(mChoice_c* choice, GAME* game) {
    static mChoice_MAIN_PROC proc[mChoice_MAIN_INDEX_NUM] = { &mChoice_Main_Hide, &mChoice_Main_Appear,
                                                              &mChoice_Main_Normal, &mChoice_Main_Disappear };
