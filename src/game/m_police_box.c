...
static mActor_name_t mPB_get_force_set_item_goods() {
    static int category_table[mSP_KIND_MAX] = { mSP_KIND_FURNITURE, mSP_KIND_PAPER, mSP_KIND_CLOTH, mSP_KIND_CARPET,
                                                mSP_KIND_WALLPAPER };
...
static mActor_name_t mPB_get_force_set_item() {
    static mPB_get_force_set_proc force_proc[mPB_CATEGORY_NUM] = { &mPB_get_force_set_item_goods,
