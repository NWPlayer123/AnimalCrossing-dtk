...
static mNpcW_GoalData_c l_kogirl_goal_data[] = { { l_kogirl_time_ed, ARRAY_SIZE(l_kogirl_time_ed, u8),
...
static mNpcW_GoalData_c l_grim_man_goal_data[] = { { l_grim_man_time_ed, ARRAY_SIZE(l_grim_man_time_ed, u8),
                                                     mNpcW_TIME_2_SEC(24, 0, 0) } };
