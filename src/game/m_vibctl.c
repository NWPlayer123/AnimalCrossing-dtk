...
static const u8 mVW_F[2] = { PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP };

static const u8 mVW_MF[3] = { PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP, PAD_MOTOR_STOP };

static const u8 mVW_MP[4] = { PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP, PAD_MOTOR_STOP, PAD_MOTOR_STOP };

static const u8 mVW_P[5] = { PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP, PAD_MOTOR_STOP, PAD_MOTOR_STOP, PAD_MOTOR_STOP };

static const u8 mVW_funbari[8] = { PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,
                                   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD };

static const u8 mVW_anahori[8] = { PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP,
                                   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP };

static const u8 mVW_anaume[60] = {
    PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE,
    PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD,
    PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD,
    PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD,
    PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD,
    PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD,
    ...
    PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD,
    PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD,
    PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD
};

static const u8 mVW_impact[9] = { PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,
                                  PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,
                                  PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD };

static const u8 mVW_ki_ga_taoreru[36] = {
    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE,
    PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,
    PAD_MOTOR_STOP,      PAD_MOTOR_STOP,      PAD_MOTOR_STOP,      PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,
    PAD_MOTOR_STOP,      PAD_MOTOR_STOP,      PAD_MOTOR_RUMBLE,    PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,
    PAD_MOTOR_STOP,      PAD_MOTOR_RUMBLE,    PAD_MOTOR_STOP,      PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,
    PAD_MOTOR_RUMBLE,    PAD_MOTOR_STOP,      PAD_MOTOR_STOP,      PAD_MOTOR_STOP,   PAD_MOTOR_STOP,   PAD_MOTOR_RUMBLE
};

static const u8 mVW_ki_wo_yusuru[13] = { PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,
                                         PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_STOP_HARD,
                                         PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP,
                                         PAD_MOTOR_STOP,      PAD_MOTOR_STOP,      PAD_MOTOR_STOP,
                                         PAD_MOTOR_STOP };

static const u8 mVW_koronoda[14] = { PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,
                                     PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD,
                                     PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP,   PAD_MOTOR_STOP,      PAD_MOTOR_RUMBLE,
                                     PAD_MOTOR_STOP,      PAD_MOTOR_STOP };

static const u8 mVW_surprise[7] = { PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE,
                                    PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP };

static const u8 mVW_dummy_b[1] = { PAD_MOTOR_RUMBLE };

static const u8 mVW_sample[13] = { PAD_MOTOR_RUMBLE, PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,    PAD_MOTOR_RUMBLE,
                                   PAD_MOTOR_RUMBLE, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD, PAD_MOTOR_STOP_HARD,
                                   PAD_MOTOR_STOP,   PAD_MOTOR_STOP,      PAD_MOTOR_STOP,      PAD_MOTOR_STOP,
                                   PAD_MOTOR_STOP };

#define VIB_PROG(name) { mVW_##name, ARRAY_SIZE(mVW_##name, u8) }
static const mVibWorkData_c mVW_data[mVibctl_VIB_PROG_NUM] = { VIB_PROG(Non),
                                                               VIB_PROG(FFF),
                                                               VIB_PROG(F),
                                                               VIB_PROG(MF),
                                                               VIB_PROG(MP),
...
static void mVibInfo_elem_entry(mVibInfo_c* vib_info, int total_frames, int attack_type, int sustain_type,
                                int release_type, int attack_frames, int sustain_frames, int release_frames, f32 step) {
    if ((attack_frames != 0 || sustain_frames != 0 || release_frames != 0) &&
        (step < 640.0f && vib_info->num_elements < mVibctl_ELEM_NUM)) {
...
static void mVibInfo_force(mVibInfo_c* vib_info) {
    ...
    if (vib_info->force_stop != mVibctl_FLAG_FORCE_STOP_NONE &&
        vib_info->last_force_stop == mVibctl_FLAG_FORCE_STOP_NONE) {
        padmgr_force_stop_ON();
    } else if (vib_info->force_stop == mVibctl_FLAG_FORCE_STOP_NONE &&
               vib_info->last_force_stop != mVibctl_FLAG_FORCE_STOP_NONE) {
...
extern void mVibctl_entry(int total_frames, int attack_type, int sustain_type, int release_type, int attack_frames,
    ...
    mVibInfo_elem_entry(&mVib_info, total_frames, attack_type, sustain_type, release_type, attack_frames,
                        sustain_frames, release_frames, step);
}

extern void mVibctl_simple_entry(int total_frames, int type, int attack_frames, int sustain_frames, int release_frames,
                                 f32 step) {
    mVibInfo_elem_entry(&mVib_info, total_frames, type, type, type, attack_frames, sustain_frames, release_frames,
                        step);
}
