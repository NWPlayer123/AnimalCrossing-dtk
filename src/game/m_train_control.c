    ...
    if (Common_Get(field_type) != mFI_FIELDTYPE2_FG || !Common_Get(train_flag)) {
        ...
        if (aTRC_area_check(play, xz_pos)) {
            ...
            if (train_actor == NULL) {
                ...
                train_actor =
                    (ACTOR*)(*Common_Get(clip.structure_clip)->setup_actor_proc)((GAME*)play, TRAIN0, -1, x, 740.0f);
            ...
            if (caboose_actor == NULL) {
                caboose_actor =
                    (ACTOR*)(*Common_Get(clip.structure_clip)->setup_actor_proc)((GAME*)play, TRAIN1, -1, x, 740.0f);
                if (caboose_actor == NULL) {
