...
static void mBR_set_dl(Submenu* submenu, mSM_MenuInfo_c* menu_info, GAME* game) {
    ...
    static int color_type[2][3] = { { 195, 0, 0 }, { 70, 145, 225 } };
    ...
    mFont_SetLineStrings(game, chr_table, sizeof(chr_table), x + 119.0f, -y + 88.0f, 255, 255, 255, 255, FALSE, TRUE,
    ...
    mFont_SetLineStrings(game, str, sizeof(str), x + 171.0f, -y + 124.0f, color_p[0], color_p[1], color_p[2], 255,
                         FALSE, TRUE, 1.0f, 1.0f, mFont_MODE_POLY);

    color_p = color_type[birthday_ovl->idx != mBR_Ovl_IDX_OK];
    mFont_SetLineStrings(game, close_table, sizeof(close_table), x + 198.0f, -y + 124.0f, color_p[0], color_p[1],
                         color_p[2], 255, FALSE, TRUE, 1.0f, 1.0f, mFont_MODE_POLY);
}
