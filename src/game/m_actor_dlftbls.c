...
#define MAKE_ACTOR_DLF(actor) { 0, 0, NULL, NULL, NULL, &actor##_Profile, 0, 0, 0, 0 }

#define MAKE_ACTOR_NULL() { 0, 0, NULL, NULL, NULL, NULL, 0, 0, 0, 0 }

ACTOR_DLFTBL actor_dlftbls[] = { MAKE_ACTOR_DLF(Player),
