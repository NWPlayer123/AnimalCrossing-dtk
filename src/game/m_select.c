...
static namefunc_t nf_tbl[SCENE_NUM] = { { nf_str(" 1:", "ﾌｨｰﾙﾄﾞ ｺｰｽ1"), &game_next_play, SCENE_TEST1 },
                                        ...
                                        { nf_str("46:", "ﾏｲﾙｰﾑ ﾁｶ -> LL1"), &game_next_play,
...
static void select_move_time_month_set(int adjust) {
    static int season_table[lbRTC_MONTHS_MAX] = { mTM_SEASON_WINTER, mTM_SEASON_WINTER, mTM_SEASON_SPRING,
                                                  mTM_SEASON_SPRING, mTM_SEASON_SPRING, mTM_SEASON_SUMMER,
                                                  mTM_SEASON_SUMMER, mTM_SEASON_SUMMER, mTM_SEASON_AUTUMN,
                                                  mTM_SEASON_AUTUMN, mTM_SEASON_AUTUMN, mTM_SEASON_WINTER };
...
static void select_move_time_set(GAME_SELECT* select) {
    if (chkTrigger(BUTTON_A) || chkTrigger(BUTTON_START)) {
        ...
        {
            static SELECT_MOVE_TIME_PROC process[5] = { &select_move_time_year_set, &select_move_time_month_set,
                                                        &select_move_time_day_set, &select_move_time_hour_set,
...
static void select_move(GAME_SELECT* select) {
    static SELECT_MOVE_PROC process[SELECT_STATUS_NUM] = { &select_move_main, &select_move_setup, &select_move_time_set,
...
static void select_draw_main(GAME_SELECT* select) {
    static SELECT_PRINT_PROC print_process[11] = { &select_print_rtc,     &select_print_time,  &select_print_step,
                                                   &select_print_weather, &select_print_sex,   &select_print_face_type,
                                                   &select_print_swell,   &select_print_decoy, &select_print_cloth,
                                                   &select_print_sunburn, &select_print_event };
