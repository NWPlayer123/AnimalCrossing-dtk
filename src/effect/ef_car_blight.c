...
xyz_t light_make_pos[] = {
    { 0.0f, 30.0f, 0.0f },  { 20.0f, 20.0f, 0.0f }, { 40.0f, 10.0f, 0.0f }, { -10.0f, 60.0f, 0.0f },
    { 10.0f, 50.0f, 0.0f }, { 30.0f, 40.0f, 0.0f }, { 50.0f, 30.0f, 0.0f }, { 0.0f, 80.0f, 0.0f },
    { 20.0f, 70.0f, 0.0f }, { 40.0f, 60.0f, 0.0f }, { 60.0f, 50.0f, 0.0f }, { 30.0f, 90.0f, 0.0f },
    { 50.0f, 80.0f, 0.0f }, { 70.0f, 70.0f, 0.0f }, { 90.0f, 60.0f, 0.0f }, { 100.0f, 80.0f, 0.0f },
};
...
static void eCar_Blight_dw(eEC_Effect_c* effect, GAME* game) {
    ...
    if (effect->arg0 == 0) {
        ...
        if (gfx != NULL) {
            ...
            gfx =
                two_tex_scroll_dolphin(game->graph, 0, timer * 3, timer * 3, 16, 16, 1, timer * 3, timer * -7, 16, 16);
            if (gfx != NULL) {
