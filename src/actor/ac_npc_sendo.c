...
ACTOR_PROFILE Npc_Sendo_Profile = { mAc_PROFILE_NPC_SENDO, ACTOR_PART_NPC,          ACTOR_STATE_NONE, SP_NPC_SENDO,
                                    ACTOR_OBJ_BANK_KEEP,   sizeof(NPC_SENDO_ACTOR), &aSEN_actor_ct,   &aSEN_actor_dt,
                                    &aSEN_actor_init,      mActor_NONE_PROC1,       &aSEN_actor_save };
...
static void aSEN_actor_ct(ACTOR* actorx, GAME* game) {
    static aNPC_ct_data_c ct_data = { &aSEN_actor_move, &aSEN_actor_draw,   5, (aNPC_TALK_REQUEST_PROC)&none_proc1,
                                      &aSEN_talk_init,  &aSEN_talk_end_chk, 0 };
