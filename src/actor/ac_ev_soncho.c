...
ACTOR_PROFILE Ev_Soncho_Profile = { mAc_PROFILE_EV_SONCHO, ACTOR_PART_NPC,      0,
                                    SP_NPC_EV_SONCHO,      ACTOR_OBJ_BANK_KEEP, sizeof(EVENT_SONCHO_ACTOR),
                                    &aESC_actor_ct,        &aESC_actor_dt,      &aESC_actor_init,
                                    mActor_NONE_PROC1,     &aESC_actor_save };

static aNPC_ct_data_c ct_data = { &aESC_actor_move, &aESC_actor_draw,   4, &aESC_talk_request,
                                  &aESC_talk_init,  &aESC_talk_end_chk, 1 };
