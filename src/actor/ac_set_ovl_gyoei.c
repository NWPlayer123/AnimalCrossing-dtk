...
static aSOG_term_info_c r_m1_t0[14] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5), FISH_SPAWN(BROOK_TROUT, POOL, 5),      FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),          FISH_SPAWN(SMALL_BASS, RIVER, 3),      FISH_SPAWN(BASS, RIVER, 2),
    FISH_SPAWN(LARGE_BASS, RIVER, 1),   FISH_SPAWN(BARBEL_STEED, RIVER, 5),    FISH_SPAWN(DACE, RIVER, 10),
    FISH_SPAWN(BITTERLING, RIVER, 20),  FISH_SPAWN(POND_SMELT, RIVER, 40),     FISH_SPAWN(STRINGFISH, RIVER, 1),
    FISH_SPAWN(GOLDFISH, RIVER, 1),     FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
};
...
static aSOG_term_info_c r_m1_t2[14] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5), FISH_SPAWN(BROOK_TROUT, POOL, 5),      FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),          FISH_SPAWN(SMALL_BASS, RIVER, 3),      FISH_SPAWN(BASS, RIVER, 2),
    FISH_SPAWN(LARGE_BASS, RIVER, 1),   FISH_SPAWN(BARBEL_STEED, RIVER, 15),   FISH_SPAWN(DACE, RIVER, 15),
    FISH_SPAWN(BITTERLING, RIVER, 15),  FISH_SPAWN(POND_SMELT, RIVER, 30),     FISH_SPAWN(STRINGFISH, RIVER, 1),
    FISH_SPAWN(GOLDFISH, RIVER, 1),     FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
};

static aSOG_term_list_c r_begining_january[aSOG_TIME_NUM] = {
    { 14, r_m1_t2 }, { 14, r_m1_t0 }, { 14, r_m1_t1 }, { 14, r_m1_t0 }
};

static aSOG_term_list_c s_begining_january[aSOG_TIME_NUM] = {
    { 2, s_m1_t0 }, { 2, s_m1_t0 }, { 2, s_m1_t0 }, { 2, s_m1_t0 }
};
...
static aSOG_term_list_c r_begining_february[aSOG_TIME_NUM] = {
    { 14, r_m2_t2 }, { 14, r_m2_t0 }, { 14, r_m2_t1 }, { 14, r_m2_t0 }
};

static aSOG_term_list_c s_begining_february[aSOG_TIME_NUM] = {
    { 2, s_m2_t0 }, { 2, s_m2_t0 }, { 2, s_m2_t0 }, { 2, s_m2_t0 }
};
...
static aSOG_term_info_c r_m3_t1[13] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 22),    FISH_SPAWN(BROOK_TROUT, POOL, 15),  FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 3),       FISH_SPAWN(BASS, RIVER, 3),         FISH_SPAWN(LARGE_BASS, RIVER, 2),
    FISH_SPAWN(BLUEGILL, RIVER, 2),         FISH_SPAWN(BARBEL_STEED, RIVER, 5), FISH_SPAWN(PALE_CHUB, RIVER, 5),
    FISH_SPAWN(LOACH, RIVER, 35),           FISH_SPAWN(GOLDFISH, RIVER, 1),     FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(POPEYED_GOLDFISH, RIVER, 1),
};

static aSOG_term_info_c r_m3_t2[12] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 21), FISH_SPAWN(BROOK_TROUT, POOL, 10),   FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),           FISH_SPAWN(SMALL_BASS, RIVER, 3),    FISH_SPAWN(BASS, RIVER, 2),
    FISH_SPAWN(LARGE_BASS, RIVER, 1),    FISH_SPAWN(BARBEL_STEED, RIVER, 15), FISH_SPAWN(DACE, RIVER, 15),
    FISH_SPAWN(LOACH, RIVER, 25),        FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
};

static aSOG_term_list_c r_begining_march[aSOG_TIME_NUM] = {
    { 12, r_m3_t2 }, { 15, r_m3_t0 }, { 13, r_m3_t1 }, { 15, r_m3_t0 }
};

static aSOG_term_list_c s_begining_march[aSOG_TIME_NUM] = {
    { 3, s_m3_t0 }, { 3, s_m3_t0 }, { 3, s_m3_t0 }, { 3, s_m3_t0 }
};
...
static aSOG_term_info_c r_m4_t1[15] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 24), FISH_SPAWN(BROOK_TROUT, POOL, 15),
    FISH_SPAWN(CARP, RIVER, 3),          FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 3),          FISH_SPAWN(LARGE_BASS, RIVER, 2),
    FISH_SPAWN(BLUEGILL, RIVER, 2),      FISH_SPAWN(BARBEL_STEED, RIVER, 5),
    FISH_SPAWN(PALE_CHUB, RIVER, 10),    FISH_SPAWN(LOACH, RIVER, 24),
    FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(GUPPY, RIVER, 1),         FISH_SPAWN(POPEYED_GOLDFISH, RIVER, 1),
    FISH_SPAWN(KILLIFISH, RIVER, 1),
};

static aSOG_term_info_c r_m4_t2[13] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 20), FISH_SPAWN(BROOK_TROUT, POOL, 10),   FISH_SPAWN(CARP, RIVER, 14),
    FISH_SPAWN(KOI, RIVER, 1),           FISH_SPAWN(SMALL_BASS, RIVER, 5),    FISH_SPAWN(BASS, RIVER, 3),
    FISH_SPAWN(LARGE_BASS, RIVER, 2),    FISH_SPAWN(BARBEL_STEED, RIVER, 15), FISH_SPAWN(DACE, RIVER, 15),
    FISH_SPAWN(LOACH, RIVER, 10),        FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(KILLIFISH, RIVER, 1),
};

static aSOG_term_list_c r_begining_april[aSOG_TIME_NUM] = {
    { 13, r_m4_t2 }, { 16, r_m4_t0 }, { 15, r_m4_t1 }, { 16, r_m4_t0 }
};

static aSOG_term_list_c s_begining_april[aSOG_TIME_NUM] = {
    { 3, s_m4_t0 }, { 3, s_m4_t0 }, { 3, s_m4_t0 }, { 3, s_m4_t0 }
};

static aSOG_term_list_c p_begining_april[aSOG_TIME_NUM] = {
    { 2, p_m4_t0 }, { 2, p_m4_t0 }, { 2, p_m4_t0 }, { 2, p_m4_t0 }
};

static aSOG_term_info_c r_m5_t0[18] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 11),   FISH_SPAWN(BROOK_TROUT, POOL, 10),
    FISH_SPAWN(CARP, RIVER, 14),           FISH_SPAWN(KOI, RIVER, 1),
    FISH_SPAWN(CATFISH, RIVER, 2),         FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 15),           FISH_SPAWN(LARGE_BASS, RIVER, 5),
    FISH_SPAWN(BARBEL_STEED, RIVER, 3),    FISH_SPAWN(DACE, RIVER, 5),
    FISH_SPAWN(LOACH, RIVER, 3),           FISH_SPAWN(CHERRY_SALMON, RIVER, 5),
    FISH_SPAWN(LARGE_CHAR, WATERFALL, 10), FISH_SPAWN(RAINBOW_TROUT, RIVER, 5),
    FISH_SPAWN(GOLDFISH, RIVER, 1),        FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(ANGELFISH, RIVER, 1),       FISH_SPAWN(KILLIFISH, RIVER, 1),
};
...
static aSOG_term_info_c r_m5_t1[15] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 18), FISH_SPAWN(BROOK_TROUT, POOL, 15),
    FISH_SPAWN(CARP, RIVER, 3),          FISH_SPAWN(SMALL_BASS, RIVER, 20),
    FISH_SPAWN(BASS, RIVER, 5),          FISH_SPAWN(LARGE_BASS, RIVER, 2),
    FISH_SPAWN(BLUEGILL, RIVER, 10),     FISH_SPAWN(BARBEL_STEED, RIVER, 5),
    FISH_SPAWN(PALE_CHUB, RIVER, 10),    FISH_SPAWN(LOACH, RIVER, 5),
    FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(GUPPY, RIVER, 1),         FISH_SPAWN(POPEYED_GOLDFISH, RIVER, 1),
    FISH_SPAWN(KILLIFISH, RIVER, 1),
};
...
static aSOG_term_info_c r_m5_t2[15] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 16),   FISH_SPAWN(BROOK_TROUT, POOL, 10),
    FISH_SPAWN(CARP, RIVER, 14),           FISH_SPAWN(KOI, RIVER, 1),
    FISH_SPAWN(CATFISH, RIVER, 5),         FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 15),           FISH_SPAWN(LARGE_BASS, RIVER, 5),
    FISH_SPAWN(BARBEL_STEED, RIVER, 10),   FISH_SPAWN(DACE, RIVER, 10),
    FISH_SPAWN(LOACH, RIVER, 3),           FISH_SPAWN(GOLDFISH, RIVER, 1),
    FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3), FISH_SPAWN(ANGELFISH, RIVER, 1),
    FISH_SPAWN(KILLIFISH, RIVER, 1),
};

static aSOG_term_list_c r_begining_may[aSOG_TIME_NUM] = {
    { 15, r_m5_t2 }, { 18, r_m5_t0 }, { 15, r_m5_t1 }, { 18, r_m5_t0 }
};

static aSOG_term_list_c s_begining_may[aSOG_TIME_NUM] = {
    { 3, s_m5_t0 }, { 3, s_m5_t0 }, { 3, s_m5_t0 }, { 3, s_m5_t0 }
};

static aSOG_term_list_c p_begining_may[aSOG_TIME_NUM] = {
    { 3, p_m5_t0 }, { 3, p_m5_t0 }, { 3, p_m5_t0 }, { 3, p_m5_t0 }
};
...
static aSOG_term_info_c r_m6_t1[16] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 17),   FISH_SPAWN(BROOK_TROUT, POOL, 15),    FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 20),     FISH_SPAWN(BASS, RIVER, 5),           FISH_SPAWN(LARGE_BASS, RIVER, 2),
    FISH_SPAWN(BLUEGILL, RIVER, 10),       FISH_SPAWN(GIANT_SNAKEHEAD, POOL, 5), FISH_SPAWN(BARBEL_STEED, RIVER, 5),
    FISH_SPAWN(PALE_CHUB, RIVER, 10),      FISH_SPAWN(GOLDFISH, RIVER, 1),       FISH_SPAWN(PIRANHA, RIVER, 1),
    FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3), FISH_SPAWN(GUPPY, RIVER, 1),          FISH_SPAWN(POPEYED_GOLDFISH, RIVER, 1),
    FISH_SPAWN(KILLIFISH, RIVER, 1),
};

static aSOG_term_info_c r_m6_t2[17] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 5), FISH_SPAWN(BROOK_TROUT, POOL, 5), FISH_SPAWN(CARP, RIVER, 5),
    FISH_SPAWN(KOI, RIVER, 1),          FISH_SPAWN(CATFISH, RIVER, 29),   FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 10),        FISH_SPAWN(LARGE_BASS, RIVER, 5), FISH_SPAWN(GIANT_CATFISH, POOL, 10),
    FISH_SPAWN(BARBEL_STEED, RIVER, 5), FISH_SPAWN(DACE, RIVER, 3),       FISH_SPAWN(GOLDFISH, RIVER, 1),
    FISH_SPAWN(PIRANHA, RIVER, 1),      FISH_SPAWN(EEL, RIVER, 10),       FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(ANGELFISH, RIVER, 1),    FISH_SPAWN(KILLIFISH, RIVER, 1),
};

static aSOG_term_list_c r_begining_june[aSOG_TIME_NUM] = {
    { 17, r_m6_t2 }, { 20, r_m6_t0 }, { 16, r_m6_t1 }, { 20, r_m6_t0 }
};

static aSOG_term_list_c s_begining_june[aSOG_TIME_NUM] = {
    { 3, s_m6_t0 }, { 3, s_m6_t0 }, { 3, s_m6_t0 }, { 3, s_m6_t0 }
};

static aSOG_term_list_c p_begining_june[aSOG_TIME_NUM] = {
    { 3, p_m6_t0 }, { 3, p_m6_t0 }, { 3, p_m6_t0 }, { 3, p_m6_t0 }
};

static aSOG_term_info_c r_m7_t0[19] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),  FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 5),          FISH_SPAWN(KOI, RIVER, 1),
    FISH_SPAWN(CATFISH, RIVER, 5),       FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 15),         FISH_SPAWN(LARGE_BASS, RIVER, 5),
    FISH_SPAWN(GIANT_CATFISH, POOL, 10), FISH_SPAWN(BARBEL_STEED, RIVER, 3),
    FISH_SPAWN(DACE, RIVER, 3),          FISH_SPAWN(SWEETFISH, RIVER, 23),
    FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(AROWANA, RIVER, 1),
    FISH_SPAWN(EEL, RIVER, 5),           FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(ANGELFISH, RIVER, 1),     FISH_SPAWN(KILLIFISH, RIVER, 1),
...
static aSOG_term_info_c r_m7_t1[17] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 8), FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),         FISH_SPAWN(SMALL_BASS, RIVER, 15),
    FISH_SPAWN(BASS, RIVER, 5),         FISH_SPAWN(LARGE_BASS, RIVER, 2),
    FISH_SPAWN(BLUEGILL, RIVER, 10),    FISH_SPAWN(GIANT_SNAKEHEAD, POOL, 10),
    FISH_SPAWN(BARBEL_STEED, RIVER, 5), FISH_SPAWN(PALE_CHUB, RIVER, 5),
    FISH_SPAWN(SWEETFISH, RIVER, 24),   FISH_SPAWN(GOLDFISH, RIVER, 1),
    FISH_SPAWN(PIRANHA, RIVER, 1),      FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(GUPPY, RIVER, 1),        FISH_SPAWN(POPEYED_GOLDFISH, RIVER, 1),
    FISH_SPAWN(KILLIFISH, RIVER, 1),
};
...
static aSOG_term_info_c r_m7_t2[19] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 7),  FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),          FISH_SPAWN(KOI, RIVER, 1),
    FISH_SPAWN(CATFISH, RIVER, 23),      FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 5),          FISH_SPAWN(LARGE_BASS, RIVER, 5),
    FISH_SPAWN(GIANT_CATFISH, POOL, 10), FISH_SPAWN(BARBEL_STEED, RIVER, 5),
    FISH_SPAWN(DACE, RIVER, 3),          FISH_SPAWN(SWEETFISH, RIVER, 5),
    FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(PIRANHA, RIVER, 1),
    FISH_SPAWN(EEL, RIVER, 15),          FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(ANGELFISH, RIVER, 1),     FISH_SPAWN(KILLIFISH, RIVER, 1),
    FISH_SPAWN(ARAPAIMA, RIVER, 1),
};

static aSOG_term_list_c r_begining_july[aSOG_TIME_NUM] = {
    { 19, r_m7_t2 }, { 19, r_m7_t0 }, { 17, r_m7_t1 }, { 19, r_m7_t0 }
};

static aSOG_term_list_c s_begining_july[aSOG_TIME_NUM] = {
    { 3, s_m7_t0 }, { 3, s_m7_t0 }, { 3, s_m7_t0 }, { 3, s_m7_t0 }
};

static aSOG_term_list_c p_begining_july[aSOG_TIME_NUM] = {
    { 3, p_m7_t0 }, { 3, p_m7_t0 }, { 3, p_m7_t0 }, { 3, p_m7_t0 }
};
...
static aSOG_term_list_c r_begining_august[aSOG_TIME_NUM] = {
    { 19, r_m8_t2 }, { 19, r_m8_t0 }, { 17, r_m8_t1 }, { 19, r_m8_t0 }
};

static aSOG_term_list_c s_begining_august[aSOG_TIME_NUM] = {
    { 3, s_m8_t0 }, { 3, s_m8_t0 }, { 3, s_m8_t0 }, { 3, s_m8_t0 }
};

static aSOG_term_list_c s_latter_august[aSOG_TIME_NUM] = {
    { 3, s_m8_t0_2 }, { 3, s_m8_t0_2 }, { 3, s_m8_t1_2 }, { 3, s_m8_t0_2 }
};

static aSOG_term_list_c p_begining_august[aSOG_TIME_NUM] = {
    { 3, p_m8_t0 }, { 3, p_m8_t0 }, { 3, p_m8_t0 }, { 3, p_m8_t0 }
};
...
static aSOG_term_info_c r_m9_t0_2[18] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 4),  FISH_SPAWN(BROOK_TROUT, POOL, 5),
    FISH_SPAWN(CARP, RIVER, 3),          FISH_SPAWN(KOI, RIVER, 1),
    FISH_SPAWN(CATFISH, RIVER, 3),       FISH_SPAWN(SMALL_BASS, RIVER, 3),
    FISH_SPAWN(BASS, RIVER, 3),          FISH_SPAWN(LARGE_BASS, RIVER, 2),
    FISH_SPAWN(BARBEL_STEED, RIVER, 3),  FISH_SPAWN(DACE, RIVER, 3),
    FISH_SPAWN(CHERRY_SALMON, RIVER, 5), FISH_SPAWN(LARGE_CHAR, WATERFALL, 5),
    FISH_SPAWN(RAINBOW_TROUT, RIVER, 5), FISH_SPAWN(SALMON, RIVER, 49),
    FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(ANGELFISH, RIVER, 1),     FISH_SPAWN(ARAPAIMA, RIVER, 1),
};
...
static aSOG_term_info_c r_m9_t1[15] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 16),   FISH_SPAWN(BROOK_TROUT, POOL, 15),  FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(SMALL_BASS, RIVER, 20),     FISH_SPAWN(BASS, RIVER, 5),         FISH_SPAWN(LARGE_BASS, RIVER, 2),
    FISH_SPAWN(BLUEGILL, RIVER, 10),       FISH_SPAWN(BARBEL_STEED, RIVER, 5), FISH_SPAWN(PALE_CHUB, RIVER, 10),
    FISH_SPAWN(SWEETFISH, RIVER, 5),       FISH_SPAWN(GOLDFISH, RIVER, 2),     FISH_SPAWN(PIRANHA, RIVER, 1),
    FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3), FISH_SPAWN(GUPPY, RIVER, 1),        FISH_SPAWN(POPEYED_GOLDFISH, RIVER, 2),
};

static aSOG_term_info_c r_m9_t1_2[14] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 6), FISH_SPAWN(BROOK_TROUT, POOL, 10),
    FISH_SPAWN(CARP, RIVER, 3),         FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 3),         FISH_SPAWN(LARGE_BASS, RIVER, 2),
    FISH_SPAWN(BLUEGILL, RIVER, 5),     FISH_SPAWN(BARBEL_STEED, RIVER, 5),
    FISH_SPAWN(PALE_CHUB, RIVER, 5),    FISH_SPAWN(SALMON, RIVER, 50),
    FISH_SPAWN(GOLDFISH, RIVER, 1),     FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(GUPPY, RIVER, 1),        FISH_SPAWN(POPEYED_GOLDFISH, RIVER, 1),
};
...
static aSOG_term_info_c r_m9_t2[17] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 16), FISH_SPAWN(BROOK_TROUT, POOL, 5), FISH_SPAWN(CARP, RIVER, 3),
    FISH_SPAWN(KOI, RIVER, 1),           FISH_SPAWN(CATFISH, RIVER, 24),   FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 15),         FISH_SPAWN(LARGE_BASS, RIVER, 5), FISH_SPAWN(BARBEL_STEED, RIVER, 5),
    FISH_SPAWN(DACE, RIVER, 3),          FISH_SPAWN(SWEETFISH, RIVER, 5),  FISH_SPAWN(GOLDFISH, RIVER, 2),
    FISH_SPAWN(PIRANHA, RIVER, 1),       FISH_SPAWN(EEL, RIVER, 5),        FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(ANGELFISH, RIVER, 1),     FISH_SPAWN(ARAPAIMA, RIVER, 1),
};
...
static aSOG_term_list_c r_begining_september[aSOG_TIME_NUM] = {
    { 17, r_m9_t2 }, { 20, r_m9_t0 }, { 15, r_m9_t1 }, { 20, r_m9_t0 }
};

static aSOG_term_list_c r_latter_september[aSOG_TIME_NUM] = {
    { 15, r_m9_t2_2 }, { 18, r_m9_t0_2 }, { 14, r_m9_t1_2 }, { 18, r_m9_t0_2 }
};

static aSOG_term_list_c s_begining_september[aSOG_TIME_NUM] = {
    { 3, s_m9_t0 }, { 3, s_m9_t0 }, { 3, s_m9_t1 }, { 3, s_m9_t0 }
};

static aSOG_term_list_c s_latter_september[aSOG_TIME_NUM] = {
    { 3, s_m9_t0_2 }, { 3, s_m9_t0_2 }, { 3, s_m9_t0_2 }, { 3, s_m9_t0_2 }
};

static aSOG_term_list_c p_begining_september[aSOG_TIME_NUM] = {
    { 1, p_m9_t0 }, { 1, p_m9_t0 }, { 1, p_m9_t0 }, { 1, p_m9_t0 }
};

static aSOG_term_info_c r_m10_t0[16] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 6),    FISH_SPAWN(BROOK_TROUT, POOL, 10),
    FISH_SPAWN(CARP, RIVER, 15),           FISH_SPAWN(KOI, RIVER, 1),
    FISH_SPAWN(CATFISH, RIVER, 2),         FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 15),           FISH_SPAWN(LARGE_BASS, RIVER, 5),
    FISH_SPAWN(BARBEL_STEED, RIVER, 3),    FISH_SPAWN(DACE, RIVER, 3),
    FISH_SPAWN(CHERRY_SALMON, RIVER, 10),  FISH_SPAWN(LARGE_CHAR, WATERFALL, 10),
    FISH_SPAWN(RAINBOW_TROUT, RIVER, 10),  FISH_SPAWN(GOLDFISH, RIVER, 1),
    FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3), FISH_SPAWN(ANGELFISH, RIVER, 1),
};
...
static aSOG_term_info_c r_m10_t2[13] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 19), FISH_SPAWN(BROOK_TROUT, POOL, 10), FISH_SPAWN(CARP, RIVER, 15),
    FISH_SPAWN(KOI, RIVER, 1),           FISH_SPAWN(CATFISH, RIVER, 5),     FISH_SPAWN(SMALL_BASS, RIVER, 5),
    FISH_SPAWN(BASS, RIVER, 15),         FISH_SPAWN(LARGE_BASS, RIVER, 5),  FISH_SPAWN(BARBEL_STEED, RIVER, 10),
    FISH_SPAWN(DACE, RIVER, 10),         FISH_SPAWN(GOLDFISH, RIVER, 1),    FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
    FISH_SPAWN(ANGELFISH, RIVER, 1),
};

static aSOG_term_list_c r_begining_october[aSOG_TIME_NUM] = {
    { 13, r_m10_t2 }, { 16, r_m10_t0 }, { 13, r_m10_t1 }, { 16, r_m10_t0 }
};

static aSOG_term_list_c s_begining_october[aSOG_TIME_NUM] = {
    { 3, s_m10_t0 }, { 3, s_m10_t0 }, { 3, s_m10_t0 }, { 3, s_m10_t0 }
};

static aSOG_term_info_c r_m11_t0[14] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 15), FISH_SPAWN(BROOK_TROUT, POOL, 10),     FISH_SPAWN(CARP, RIVER, 15),
    FISH_SPAWN(KOI, RIVER, 1),           FISH_SPAWN(SMALL_BASS, RIVER, 5),      FISH_SPAWN(BASS, RIVER, 15),
    FISH_SPAWN(LARGE_BASS, RIVER, 5),    FISH_SPAWN(BARBEL_STEED, RIVER, 5),    FISH_SPAWN(DACE, RIVER, 5),
    FISH_SPAWN(CHERRY_SALMON, RIVER, 5), FISH_SPAWN(LARGE_CHAR, WATERFALL, 10), FISH_SPAWN(RAINBOW_TROUT, RIVER, 5),
    FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
};
...
static aSOG_term_info_c r_m11_t2[11] = {
    FISH_SPAWN(CRUCIAN_CARP, RIVER, 15), FISH_SPAWN(BROOK_TROUT, POOL, 10),     FISH_SPAWN(CARP, RIVER, 15),
    FISH_SPAWN(KOI, RIVER, 1),           FISH_SPAWN(SMALL_BASS, RIVER, 5),      FISH_SPAWN(BASS, RIVER, 15),
    FISH_SPAWN(LARGE_BASS, RIVER, 5),    FISH_SPAWN(BARBEL_STEED, RIVER, 15),   FISH_SPAWN(DACE, RIVER, 15),
    FISH_SPAWN(GOLDFISH, RIVER, 1),      FISH_SPAWN(FRESHWATER_GOBY, RIVER, 3),
};

static aSOG_term_list_c r_begining_november[aSOG_TIME_NUM] = {
    { 11, r_m11_t2 }, { 14, r_m11_t0 }, { 13, r_m11_t1 }, { 14, r_m11_t0 }
};

static aSOG_term_list_c s_begining_november[aSOG_TIME_NUM] = {
    { 3, s_m11_t0 }, { 3, s_m11_t0 }, { 3, s_m11_t0 }, { 3, s_m11_t0 }
};
...
static aSOG_term_list_c r_begining_december[aSOG_TIME_NUM] = {
    { 14, r_m12_t2 }, { 14, r_m12_t0 }, { 14, r_m12_t1 }, { 14, r_m12_t0 }
};

static aSOG_term_list_c s_begining_december[aSOG_TIME_NUM] = {
    { 2, s_m12_t0 }, { 2, s_m12_t0 }, { 2, s_m12_t0 }, { 2, s_m12_t0 }
};
...
static aSOG_term_list_c* r_month[lbRTC_MONTHS_MAX][aSOG_TERM_NUM] = {
    { r_begining_january, r_begining_january },   { r_begining_february, r_begining_february },
    { r_begining_march, r_begining_march },       { r_begining_april, r_begining_april },
    { r_begining_may, r_begining_may },           { r_begining_june, r_begining_june },
    { r_begining_july, r_begining_july },         { r_begining_august, r_begining_august },
    { r_begining_september, r_latter_september }, { r_begining_october, r_begining_october },
    { r_begining_november, r_begining_november }, { r_begining_december, r_begining_december },
};

/* ocean fish by month */
static aSOG_term_list_c* s_month[lbRTC_MONTHS_MAX][aSOG_TERM_NUM] = {
    { s_begining_january, s_begining_january },   { s_begining_february, s_begining_february },
    { s_begining_march, s_begining_march },       { s_begining_april, s_begining_april },
    { s_begining_may, s_begining_may },           { s_begining_june, s_begining_june },
    { s_begining_july, s_begining_july },         { s_begining_august, s_latter_august },
    { s_begining_september, s_latter_september }, { s_begining_october, s_begining_october },
    { s_begining_november, s_begining_november }, { s_begining_december, s_begining_december },
};
...
static aSOG_term_list_c f_event[aSOG_TIME_NUM] = { { 3, f_bs_t2 }, { 3, f_bs_t0 }, { 3, f_bs_t1 }, { 3, f_bs_t0 } };

static aSOG_term_list_c f_island[aSOG_TIME_NUM] = { { 3, f_il_t2 }, { 3, f_il_t0 }, { 3, f_il_t1 }, { 3, f_il_t0 } };
 ...
 * @return Spawn is invalid: aSOG_FISH_TYPE_INVALID/aSOG_FISH_TYPE_NUM, otherwise index into the spawn_info table to try
 *spawning
 **/
