...
ACTOR_PROFILE T_Hat1_Profile = { mAc_PROFILE_T_HAT1,
                                 ACTOR_PART_BG,
...
static void aTHT1_setupAction(ACTOR* actor, int action) {
    ...
    static HAT1_PROC process[] = { (HAT1_PROC)none_proc1, (HAT1_PROC)none_proc1, (HAT1_PROC)none_proc1,
                                   aTHT1_destruct,        (HAT1_PROC)none_proc1, NULL };
