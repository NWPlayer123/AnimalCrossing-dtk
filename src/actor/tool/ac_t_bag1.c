...
ACTOR_PROFILE T_Bag1_Profile = { mAc_PROFILE_T_BAG1,
                                 ACTOR_PART_BG,
...
static void aTBG1_setupAction(ACTOR* actor, int action) {
    ...
    static BAG1_PROC process[] = { (BAG1_PROC)none_proc1, (BAG1_PROC)none_proc1, (BAG1_PROC)none_proc1,
                                   aTBG1_destruct,        (BAG1_PROC)none_proc1, NULL };
