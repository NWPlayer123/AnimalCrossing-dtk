...
ACTOR_PROFILE T_Biscus4_Profile = { mAc_PROFILE_T_BISCUS4,
                                    ACTOR_PART_BG,
...
static void aTB4_setupAction(ACTOR* actor, int action) {
    ...
    static BISCUS4_PROC process[] = { (BISCUS4_PROC)none_proc1, (BISCUS4_PROC)none_proc1,
                                      (BISCUS4_PROC)none_proc1, aTB4_destruct,
                                      (BISCUS4_PROC)none_proc1, NULL };
