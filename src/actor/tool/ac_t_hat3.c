...
ACTOR_PROFILE T_Hat3_Profile = { mAc_PROFILE_T_HAT3,
                                 ACTOR_PART_BG,
...
static void aTHT3_setupAction(ACTOR* actor, int action) {
    ...
    static HAT3_PROC process[] = { (HAT3_PROC)none_proc1, (HAT3_PROC)none_proc1, (HAT3_PROC)none_proc1,
                                   aTHT3_destruct,        (HAT3_PROC)none_proc1, NULL };
