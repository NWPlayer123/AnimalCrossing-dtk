...
ACTOR_PROFILE T_Hasu1_Profile = { mAc_PROFILE_T_HASU1,
                                  ACTOR_PART_BG,
...
static void aTHS1_setupAction(ACTOR* actor, int action) {
    ...
    static HASU1_PROC process[] = { (HASU1_PROC)none_proc1, (HASU1_PROC)none_proc1, (HASU1_PROC)none_proc1,
                                    aTHS1_destruct,         (HASU1_PROC)none_proc1, NULL };
