...
ACTOR_PROFILE T_Rei1_Profile = { mAc_PROFILE_T_REI1,
                                 ACTOR_PART_BG,
...
static void aTRI1_setupAction(ACTOR* actor, int action) {
    ...
    static REI1_PROC process[] = { (REI1_PROC)none_proc1, (REI1_PROC)none_proc1, (REI1_PROC)none_proc1,
                                   aTRI1_destruct,        (REI1_PROC)none_proc1, NULL };
