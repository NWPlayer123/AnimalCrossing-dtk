...
ACTOR_PROFILE T_Zinnia1_Profile = { mAc_PROFILE_T_ZINNIA1,
                                    ACTOR_PART_BG,
...
static void aTZN1_setupAction(ACTOR* actor, int action) {
    ...
    static ZINNIA1_PROC process[] = { (ZINNIA1_PROC)none_proc1, (ZINNIA1_PROC)none_proc1, (ZINNIA1_PROC)none_proc1,
                                      aTZN1_destruct,           (ZINNIA1_PROC)none_proc1, NULL };
