...
ACTOR_PROFILE T_Cobra1_Profile = { mAc_PROFILE_T_COBRA1,
                                   ACTOR_PART_BG,
...
static void aTCB1_setupAction(ACTOR* actor, int action) {
    ...
    static COBRA1_PROC process[] = { (COBRA1_PROC)none_proc1, (COBRA1_PROC)none_proc1, (COBRA1_PROC)none_proc1,
                                     aTCB1_destruct,          (COBRA1_PROC)none_proc1, NULL };
