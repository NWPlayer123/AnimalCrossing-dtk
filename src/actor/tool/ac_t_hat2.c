...
ACTOR_PROFILE T_Hat2_Profile = { mAc_PROFILE_T_HAT2,
                                 ACTOR_PART_BG,
...
static void aTHT2_setupAction(ACTOR* actor, int action) {
    ...
    static HAT2_PROC process[] = { (HAT2_PROC)none_proc1, (HAT2_PROC)none_proc1, (HAT2_PROC)none_proc1,
                                   aTHT2_destruct,        (HAT2_PROC)none_proc1, NULL };
