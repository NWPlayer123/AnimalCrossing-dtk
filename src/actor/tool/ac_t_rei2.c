...
ACTOR_PROFILE T_Rei2_Profile = { mAc_PROFILE_T_REI2,
                                 ACTOR_PART_BG,
...
static void aTRI2_setupAction(ACTOR* actor, int action) {
    ...
    static REI2_PROC process[] = { (REI2_PROC)none_proc1, (REI2_PROC)none_proc1, (REI2_PROC)none_proc1,
                                   aTRI2_destruct,        (REI2_PROC)none_proc1, NULL };
