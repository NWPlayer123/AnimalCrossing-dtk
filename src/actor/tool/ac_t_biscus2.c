...
ACTOR_PROFILE T_Biscus2_Profile = { mAc_PROFILE_T_BISCUS2,
                                    ACTOR_PART_BG,
...
static void aTB2_setupAction(ACTOR* actor, int action) {
    ...
    static BISCUS2_PROC process[] = { (BISCUS2_PROC)none_proc1, (BISCUS2_PROC)none_proc1,
                                      (BISCUS2_PROC)none_proc1, aTB2_destruct,
                                      (BISCUS2_PROC)none_proc1, NULL };
