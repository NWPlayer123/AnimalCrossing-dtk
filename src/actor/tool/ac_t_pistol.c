...
static void aTPT_actor_draw(ACTOR* actor, GAME* game) {
    ...
    if (pistol->tools_class.init_matrix == 1) {
        ...
        Matrix_translate(pistol->tools_class.actor_class.world.position.x,
                         pistol->tools_class.actor_class.world.position.y,
                         pistol->tools_class.actor_class.world.position.z, FALSE);
        Matrix_scale(0.01f, 0.01f, 0.01f, TRUE);
    }

    Matrix_scale(pistol->tools_class.actor_class.scale.x, pistol->tools_class.actor_class.scale.y,
                 pistol->tools_class.actor_class.scale.z, TRUE);
