...
ACTOR_PROFILE T_Biscus1_Profile = { mAc_PROFILE_T_BISCUS1,
                                    ACTOR_PART_BG,
...
static void aTB1_setupAction(ACTOR* actor, int action) {
    ...
    static BISCUS1_PROC process[] = { (BISCUS1_PROC)none_proc1, (BISCUS1_PROC)none_proc1,
                                      (BISCUS1_PROC)none_proc1, aTB1_destruct,
                                      (BISCUS1_PROC)none_proc1, NULL };
