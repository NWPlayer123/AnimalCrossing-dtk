...
ACTOR_PROFILE T_Anrium1_Profile = { mAc_PROFILE_T_ANRIUM1,
                                    ACTOR_PART_BG,
...
static void aTA1_setupAction(ACTOR* actor, int action) {
    ...
    static ANRIUM1_PROC process[] = { (ANRIUM1_PROC)none_proc1, (ANRIUM1_PROC)none_proc1,
                                      (ANRIUM1_PROC)none_proc1, aTA1_destruct,
                                      (ANRIUM1_PROC)none_proc1, NULL };
