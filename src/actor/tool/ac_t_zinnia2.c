...
ACTOR_PROFILE T_Zinnia2_Profile = { mAc_PROFILE_T_ZINNIA2,
                                    ACTOR_PART_BG,
...
static void aTZN2_setupAction(ACTOR* actor, int action) {
    ...
    static ZINNIA2_PROC process[] = { (ZINNIA2_PROC)none_proc1, (ZINNIA2_PROC)none_proc1, (ZINNIA2_PROC)none_proc1,
                                      aTZN2_destruct,           (ZINNIA2_PROC)none_proc1, NULL };
