...
ACTOR_PROFILE T_Biscus3_Profile = { mAc_PROFILE_T_BISCUS3,
                                    ACTOR_PART_BG,
...
static void aTB3_setupAction(ACTOR* actor, int action) {
    ...
    static BISCUS3_PROC process[] = { (BISCUS3_PROC)none_proc1, (BISCUS3_PROC)none_proc1,
                                      (BISCUS3_PROC)none_proc1, aTB3_destruct,
                                      (BISCUS3_PROC)none_proc1, NULL };
