...
ACTOR_PROFILE T_Bag2_Profile = { mAc_PROFILE_T_BAG2,
                                 ACTOR_PART_BG,
...
static void aTBG2_setupAction(ACTOR* actor, int action) {
    ...
    static BAG2_PROC process[] = { (BAG2_PROC)none_proc1, (BAG2_PROC)none_proc1, (BAG2_PROC)none_proc1,
                                   aTBG2_destruct,        (BAG2_PROC)none_proc1, NULL };
