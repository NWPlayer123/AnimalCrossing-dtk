...
ACTOR_PROFILE Tukimi_Profile = { mAc_PROFILE_TUKIMI,
                                 ACTOR_PART_ITEM,
                                 ACTOR_STATE_TA_SET,
                                 NEWYEAR_SHRINE0,
                                 ACTOR_OBJ_BANK_KEEP,
...
u8 aTUK_shadow_vtx_fix_flg_table[8] = { TRUE, TRUE, FALSE, FALSE, TRUE, FALSE, TRUE, FALSE };

extern Vtx obj_e_tukimi_l_shadow_v[];
extern Gfx obj_e_tukimi_l_shadow_model[];
static bIT_ShadowData_c aTUK_shadow_data_l = { 8, aTUK_shadow_vtx_fix_flg_table, 60.0f, obj_e_tukimi_l_shadow_v,
                                               obj_e_tukimi_l_shadow_model };

extern Vtx obj_e_tukimi_r_shadow_v[];
extern Gfx obj_e_tukimi_r_shadow_model[];
static bIT_ShadowData_c aTUK_shadow_data_r = { 8, aTUK_shadow_vtx_fix_flg_table, 60.0f, obj_e_tukimi_r_shadow_v,
