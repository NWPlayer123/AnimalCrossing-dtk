...
ACTOR_PROFILE Ev_Dokutu_Profile = { mAc_PROFILE_EV_DOKUTU, ACTOR_PART_NPC,      0,
                                    SP_NPC_EV_DOKUTU,      ACTOR_OBJ_BANK_KEEP, sizeof(EVENT_DOKUTU_ACTOR),
                                    &aEVD_actor_ct,        &aEVD_actor_dt,      &aEVD_actor_init,
                                    mActor_NONE_PROC1,     &aEVD_actor_save };

static aNPC_ct_data_c ct_data = { &aEVD_actor_move, &aEVD_actor_draw,   3, &aEVD_talk_request,
                                  &aEVD_talk_init,  &aEVD_talk_end_chk, 0 };
