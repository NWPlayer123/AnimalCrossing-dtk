...
ACTOR_PROFILE Ev_Gypsy_Profile = { mAc_PROFILE_EV_GYPSY, ACTOR_PART_NPC,         ACTOR_STATE_NONE, SP_NPC_GYPSY,
                                   ACTOR_OBJ_BANK_KEEP,  sizeof(EV_GYPSY_ACTOR), &aEGPS_actor_ct,  &aEGPS_actor_dt,
                                   &aEGPS_actor_init,    mActor_NONE_PROC1,      &aEGPS_actor_save };
...
static void aEGPS_actor_ct(ACTOR* actorx, GAME* game) {
    static aNPC_ct_data_c ct_data = { &aEGPS_actor_move, &aEGPS_actor_draw,   2, &aEGPS_talk_request,
                                      &aEGPS_talk_init,  &aEGPS_talk_end_chk, 0 };
