...
static void aAL_logo_in_init(ANIMAL_LOGO_ACTOR* actor, GAME* game) {
    cKF_SkeletonInfo_R_init(&actor->animal.skeleton, actor->animal.skeleton.skeleton, &cKF_ba_r_logo_us_animal, 1.0f,
                            121.0f, 1.0f, 0.5f, 0.0f, cKF_FRAMECONTROL_STOP, NULL);
    cKF_SkeletonInfo_R_init(&actor->cros.skeleton, actor->cros.skeleton.skeleton, &cKF_ba_r_logo_us_cros, 1.0f, 121.0f,
                            1.0f, 0.5f, 0.0f, cKF_FRAMECONTROL_STOP, NULL);
    cKF_SkeletonInfo_R_init(&actor->sing.skeleton, actor->sing.skeleton.skeleton, &cKF_ba_r_logo_us_sing, 1.0f, 121.0f,
                            1.0f, 0.5f, 0.0f, cKF_FRAMECONTROL_STOP, NULL);
