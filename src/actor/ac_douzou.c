...
ACTOR_PROFILE Douzou_Profile = {
    ...
    &aDOU_actor_ct,          &aDOU_actor_dt,  &aDOU_actor_init,   &aDOU_actor_draw, NULL
};
...
static bIT_ShadowData_c aDOU_shadow_data = { 8, aDOU_vtx_fix_flg_tbl, 60.0f, obj_s_douzou_shadow_v,
