...
ACTOR_PROFILE Npc_Curator_Profile = { mAc_PROFILE_NPC_CURATOR, ACTOR_PART_NPC,      ACTOR_STATE_NONE,
                                      SP_NPC_CURATOR,          ACTOR_OBJ_BANK_KEEP, sizeof(NPC_CURATOR_ACTOR),
                                      &aCR_actor_ct,           &aCR_actor_dt,       &aCR_actor_init,
                                      mActor_NONE_PROC1,       &aCR_actor_save };
...
static void aCR_actor_ct(ACTOR* actorx, GAME* game) {
    static aNPC_ct_data_c ct_data = { &aCR_actor_move, &aCR_actor_draw,   5, &aCR_talk_request,
                                      &aCR_talk_init,  &aCR_talk_end_chk, 0 };
