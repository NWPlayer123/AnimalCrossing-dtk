...
ACTOR_PROFILE Boat_Profile = { mAc_PROFILE_BOAT,
                               ACTOR_PART_ITEM,
                               ACTOR_STATE_CAN_MOVE_IN_DEMO_SCENES | ACTOR_STATE_TA_SET |
    ...
    switch (joint_idx) {
        case 3: {
            Matrix_translate(boat_actor->actor_class.world.position.x, boat_actor->actor_class.world.position.y,
                             boat_actor->actor_class.world.position.z, 0);
            ...
            Matrix_scale(boat_actor->actor_class.scale.x, boat_actor->actor_class.scale.y,
                         boat_actor->actor_class.scale.z, 1);
            break;
        }
