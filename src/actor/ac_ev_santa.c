...
ACTOR_PROFILE Ev_Santa_Profile = { mAc_PROFILE_EV_SANTA, ACTOR_PART_NPC,      ACTOR_STATE_NONE,
                                   SP_NPC_SANTA,         ACTOR_OBJ_BANK_KEEP, sizeof(EVENT_SANTA_ACTOR),
                                   &aESNT_actor_ct,      &aESNT_actor_dt,     &aESNT_actor_init,
                                   mActor_NONE_PROC1,    &aESNT_actor_save };

static void aESNT_actor_ct(ACTOR* actorx, GAME* game) {
    static aNPC_ct_data_c ct_data = { &aESNT_actor_move, &aESNT_actor_draw,   3, &aESNT_talk_request,
                                      &aESNT_talk_init,  &aESNT_talk_end_chk, 0 };
