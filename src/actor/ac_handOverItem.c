...
ACTOR_PROFILE HandOverItem_Profile = { mAc_PROFILE_HANDOVERITEM,
                                       ACTOR_PART_BG,
                                       ACTOR_STATE_CAN_MOVE_IN_DEMO_SCENES | ACTOR_STATE_NO_DRAW_WHILE_CULLED |
...
static aHOI_GYO_DL_c* aGYO_displayList[45] = {
    &aGYO_funa_dl,     &aGYO_hera_dl,     &aGYO_koi_dl,      &aGYO_nisiki_dl,    &aGYO_namazu_dl,
    &aGYO_bass_s_dl,   &aGYO_bass_m_dl,   &aGYO_bass_l_dl,   &aGYO_blue_gill_dl, &aGYO_oonamazu_dl,
    &aGYO_raigyo_dl,   &aGYO_nigoi_dl,    &aGYO_ugui_dl,     &aGYO_oikawa_dl,    &aGYO_tanago_dl,
    &aGYO_dojyo_dl,    &aGYO_wakasagi_dl, &aGYO_ayu_dl,      &aGYO_yamame_dl,    &aGYO_iwana_dl,
    &aGYO_niji_dl,     &aGYO_ito_dl,      &aGYO_sake_dl,     &aGYO_kingyo_dl,    &aGYO_pirania_dl,
    &aGYO_aroana_dl,   &aGYO_unagi_dl,    &aGYO_donko_dl,    &aGYO_angel_dl,     &aGYO_gupi_dl,
    &aGYO_demekin_dl,  &aGYO_kaseki_dl,   &aGYO_zarigani_dl, &aGYO_kaeru_dl,     &aGYO_medaka_dl,
    &aGYO_kurage_dl,   &aGYO_suzuki_dl,   &aGYO_tai_dl,      &aGYO_ishidai_dl,   &aGYO_piraluku_dl,
    &aGYO_piraluku_dl, &aGYO_akikan_dl,   &aGYO_nagagutu_dl, &aGYO_taiya_dl,     NULL
};
...
static Gfx* mode_DL_table[mNT_ITEM_TYPE_NUM] = { NULL,
                                                 apple_DL_mode,
                                                 orange_DL_mode,
                                                 peach_DL_mode,
                                                 pear_DL_mode,
...
static Gfx* vtx_DL_table[mNT_ITEM_TYPE_NUM] = { NULL,
                                                apple_DL_vtx,
                                                orange_DL_vtx,
                                                peach_DL_vtx,
                                                pear_DL_vtx,
